...
public class TransferManagerProvider {
    ...
    public static AmazonS3ClientBuilder getAnyS3ClientBuilderWithRegionAndCredentials(final Map<String, String> config, final String endpointConfigurationString) {
        ...
        AwsClientBuilder.EndpointConfiguration endpointConfiguration =
                new AwsClientBuilder.EndpointConfiguration(endpointConfigurationString, region);
