...
//
//        SinkRecord record = new SinkRecord("test", 0, Schema.STRING_SCHEMA, null, Schema.STRING_SCHEMA, null, 2, 64L, TimestampType.NO_TIMESTAMP_TYPE);
//        SinkRecord record2 = new SinkRecord("test", 0, Schema.STRING_SCHEMA, "".getBytes(), Schema.STRING_SCHEMA, "".getBytes(), 3, 68L, TimestampType.NO_TIMESTAMP_TYPE, null);
//        SinkRecord record3 = new SinkRecord("test", 0, Schema.STRING_SCHEMA, key, Schema.STRING_SCHEMA, value, 4, 72L, TimestampType.NO_TIMESTAMP_TYPE);
